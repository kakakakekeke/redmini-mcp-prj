...
프로젝트의 진행 상황과 작업 순서는 `document/todo.md` 파일에 의해 엄격하게 통제됩니다 (Husky `pre-commit` 훅 연동).
...
> 3. **선형적 순서 엄수**: 새로운 기능 개발 브랜치를 파기 전, 현재 대기열 1순위(`[ ]` 또는 `[/]` 중 가장 위) 작업과 브랜치명이 일치하는지 확인하십시오.
