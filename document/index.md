...
| **[[attachment_process_sop|document/sop/attachment_process_sop.md]]** | `SOP`, `첨부`, `upload`, `attachment`, `토큰`, `바인딩`, `2단계업로드`, `uploads` | • Redmine 2단계 파일 첨부 표준 절차 및 API 연동 시<br>• 업로드 후 웹 UI 미노출 원인 및 일감 바인딩 확인 시 | Redmine 2단계 파일 첨부 표준 절차서 (토큰 발급 ➔ 일감 바인딩) |
