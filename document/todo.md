...
1. [ ] `feature/get-time-entries` : 작업 시간 기록 목록/상세 조회(get_time_entries) 도구 TDD 구현 (GET /time_entries.json)
2. [ ] `feature/search-all` : Redmine 전 도메인 통합 검색(search_all) 도구 TDD 구현 (GET /search.json)
